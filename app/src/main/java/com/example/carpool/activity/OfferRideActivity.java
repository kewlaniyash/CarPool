...
public class OfferRideActivity extends BaseActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.layout_offer_ride);
        initializeUi();
        initializeListeners();
    }
    ...
    private void prepareToNJITDetails() {
        Intent chooseSourceDestinationIntent = new Intent(this, ChooseSourceDestinationActivity.class);
